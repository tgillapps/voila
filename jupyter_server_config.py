...
#  Default: ''
c.ServerApp.password = "argon2:$argon2id$v=19$m=10240,t=10,p=8$X0UrP/iCXZyHrgWwQlZf5A$JObRp+syC+y2ZSrFpKc5OdgUYu2nQPnWQ4Ggn+M92xA"
...
#  Choices: any of ['md5', 'sha256', 'sha512', 'sha3_384', 'blake2s', 'sha224', 'sha3_256', 'sha1', 'sha3_512', 'blake2b', 'sha3_224', 'sha384']
#  Default: 'sha256'
